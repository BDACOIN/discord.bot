...
async def on_ready():
    ...
    while(True):
        ...
        for p in GLOBAL_PLAYER.values():
            #print("discription:" + str(p.description))
            #print("is_live" + str(p.is_live))
            #print("player.duration:" + str(p.duration))
            pass
...
class VoiceEntry:
    ...
    def __str__(self):
        ...
        return "aaaaa" # fmt.format(self.player, self.requester)
...
class Music:
    ...
    async def play(self, ctx, *, song : str):
        ...
        try:
            player = state.voice.create_ffmpeg_player("boss_battle_96k.mp3")
...
async def on_message(message):
    ...
    if message.content == "!join":
        ...
        player = voice.create_ffmpeg_player('boss_battle_96k.mp3') # bgm/boss_battle_96k.mp3')
